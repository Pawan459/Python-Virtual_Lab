...
<div class="block1" style="margin-top: 9em;">
  ...
  <label>Demonstrate how string repeat.</label><br>
    <input type="text" class="form-control input-sm"  id="input1" placeholder="Enter the String">
    <input type="text"  class="form-control input-sm"  id="input_2" placeholder="Enter the no. of time to repeat">
...
<p id="1">s = input("Enter the String :")</p>
    <p id="2">n = input("Enter the Integer :")</p>
    <p id="3">print(s*n)</p>
</b>
</div>
</div>
...
<b>
  <p id="res_1" style="display:none;">The Repeated String is :</p>
    <p id="res_2"></p>
  </b>
</div>
</div>
<script src="js/string_repeat.js"></script>
</body>
</html> 
