...
<div class="block1" style="margin-top: 9em;">
  ...
  <label>Demonstrate how stings concate with each other.</label><br>
    <input type="text" class="form-control input-sm"  id="input1" placeholder="Enter the String">
    <input type="text"  class="form-control input-sm"  id="input_2" placeholder="Enter the another">
       <input type="text"  class="form-control input-sm"  id="input_3" placeholder="Enter the String[optional]">
...
<p id="1">s = input("Enter the String :")</p>
		<p id="2">s1 = input("Enter a String :")</p>
		<p id="3">s2 = input("[Optional]Enter a String :")</p>
		<p id="4">print(s + s1)</p>
		<p id="5">print(s +s1 +s2)</p>
</b>
</div>
</div>
...
<b>
 <p id="res_1" style="display:none;">The Concatenated String is :</p>
		<p id="res_2"></p>
  </b>
</div>
</div>
<script src="js/string_concat.js"></script>
</body>
</html> 
