      ...
      <h1 style="color: white;padding-left: 2em;font-family: Ubuntu;font-size: 35px; ">Quiz </h1>
        ...
        <div class="collapse navbar-collapse" id="collapse-1">
            <ul class="nav navbar-nav navbar-right" id="bs" style="padding-right: 3em;font-size: 29px;margin-top: 22px;">
              ...
              <li><a href="Instruction.php" class="link1" style="color: #fff;" data-toggle="modal" data-target="#myModalHorizontal">Rules</a></li>
            </ul>
        </div>
        </div>
      </nav>
...
<?php $cid="1";$level="Easy";$var=($cid-1)*30; require 'C:\xampp\htdocs\workshop\PPlab\src\lab\connection\connection.php';?>
