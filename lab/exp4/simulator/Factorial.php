...
<div class="top">
     ...
     <h1 style="font-size: 44px; color: white; ">Analysis of Factorial</h1>
     </ul>
    		
    		<div class="collapse navbar-collapse" id="collapse-1">
            <ul class="nav navbar-nav navbar-right" id="bs">
              <li><a href="../loop.php" style="font-family:  Ubuntu;">Back</a></li>  
    ...
    <div class="side" style="float: right;margin-top: 8em;">
        <a href="Fibonacci.php" style="font-family:  Ubuntu;"><button class="btn btn-primary">Fibonacci Series</button></a>
                <a href="Prime.php" style="font-family:  Ubuntu;"><button class="btn btn-primary">Prime numbers</button></a>
              </div>
...
<div class="block1" style="margin-top: 9em;">
	...
	<ul>
		<label><li>To find the Factorial of a Number.</li></label>
	</ul>
<div class="tn">
<input type="text" class="form-control input-sm" id="input_1" placeholder="Enter the Number :" ><br>
...
<div class="pre">
<div class="step1" id="step" style="display:none;text-align:left;"><b>
		...
		<p id="10" style="padding-left:30px;">print(The Factorial of the Number is :,num)</p></b>
	</div>
  </div>
  </div>
<div class="block4">
