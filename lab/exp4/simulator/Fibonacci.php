...
<body style="font-family: Ubuntu;">
	<div class="top">
     ...
     <h1 style="font-size: 44px; color: white;">Analysis of Fibonacci Series</h1>
     </ul>
...
<div class="block1" style="margin-top: 9em;">
	...
	<ul>
		<label><li>To find the Fibonacci Series.</li></label>
	</ul>
<div class="tn">
<input type="text" id="input_1" class="form-control input-sm" placeholder="Enter the Number(nterms) :"><br>
...
<div class="pre">
<div class="step1" id="step1" style="display:none;text-align:left;"><b>
		<p id="f1">n1 = 0</p>
		<p id="f2">n2 = 1</p>
		<p id="f3">count = 0</p>
