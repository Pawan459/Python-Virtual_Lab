  ...
  <div class="top">
     ...
     <div class="collapse navbar-collapse" id="collapse-1">
            <ul class="nav navbar-nav navbar-right" id="bs">
              <li><a href="" style="font-family:  Ubuntu;"></a></li>
              <li><a href="../function.php" style="font-family:  Ubuntu;">Back</a></li>  
            </ul>
        </div>
 </div>
</nav>
...
<div class="side" style="margin-top: 8em;float: right;">
 <a href="built_type.php" style="font-family:  Ubuntu;"><button class="btn btn-primary">Function by Type</button></a>
  </div>
...
<script src="built_id1.js"></script>
</body>
</html>
