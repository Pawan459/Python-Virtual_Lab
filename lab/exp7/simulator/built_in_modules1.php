     ...
     <h1 style="font-size: 44px; color: white;">Analysis of Modules</h1>
      ...
      <div class="navbar-collapse collapse">
            <ul class="nav navbar-nav navbar-right" id="bs" >
              <li><a href="../modules.php" style="font-family:  Ubuntu;">Back</a></li>
...
<div class="block1" style="margin-top: 9em;">
  <div class="header1">Problem?</div><br><br>
    ...
    <label><li>Please Provide a Single Input :</li>
     ...
     and<li> No Input</li>
      &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;For : datetime.
	  <li>Please Provide a Two Input For Other Modules :</li></label>
  <div class="select">
...
<input type="text" class="form-control input-sm" id="input_2" placeholder="Enter the Second Number">
...
<div class="pre">
  ...
  <div class="step1" id="random" style="display:none;text-align:left;padding-left: 1em;"><br><br><b>
    ...
    <p id="r6">print("The Random Number is :",b)</p></b>
  </div>
