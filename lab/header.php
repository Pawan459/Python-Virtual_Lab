...
<body data-spy="scroll" data-target=".navbar" data-offset="60" style="font-family: Ubuntu;">
     ...
     <h1 style="color: white;padding-left: 3em;font-family: Ubuntu;font-size: 35px; ">Python<br> Programming Language</h1>
    	...
    	<div class="navbar-collapse collapse">
            <ul class="nav navbar-nav navbar-left" id="bs">
            	...
            	<li><a href="#explore" style="font-family: Ubuntu;">Explore VLab</a></li>
 ...
 <li class="dropdown">
    ...
    <button class="btn btn-light btn btn-large dropdown-toggle" type="button" data-toggle="dropdown"style=" border: 3px solid #fff;border-radius: 6px;"><img src="img/user.png" width="32" height="32">
