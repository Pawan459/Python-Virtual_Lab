...
<div class="top">
     ...
     <h1 style="font-size: 44px; color: white; ">Analysis of GUI</h1>
     </ul>
    		
    		<div class="collapse navbar-collapse" id="collapse-1">
            <ul class="nav navbar-nav navbar-right" id="bs">
              
              <li><a href="../guiapp.php" style="font-family:  Ubuntu;">Back</a></li>  
...
<div class="block1" style="margin-top: 9em;">
	...
	<ul><br><br><br>
		<label><li>Click on Start to get the code.</li><br><li>Click on Execute to run the GUI Application</li></label>
	</ul>
<div class="tn">
<button class="btn btn-primary" id="btn_1">Start</button>
<button class="btn btn-primary" id="btn_3">Execute</button>
</div>
</div>
</div>
...
<div class="step1" id="step" style="display:none;text-align:left;">
		<textarea style = "height: 355px; width: 880px" readonly name = "script"><?= $codecopy ?></textarea>
	</div>
    </div>
</div>
</div>
...
<form name = "inputs" action = "getcodegui.php" method = "POST"></form>
